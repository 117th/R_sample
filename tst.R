...
#renderInlineCode("CourseTemplate.docx","CourseTemplateOut.docx")
#addPlots("CourseTemplate.docx","CourseTemplateOut.docx", plots)
...
#renderInlineCode("template.docx","templateOut.docx")
